...
class BeliefManager:
    ...
    def update_belief(self, belief_id: str, new_confidence: float, reason: str, evidence: str) -> Optional[BeliefUpdate]:
        """
        更新投资信念
    ...
    def get_belief(self, belief_id: str) -> Optional[InvestmentBelief]:
        """
        获取投资信念
...
class BeliefPropagation:
    ...
    def propagate_beliefs(
        self,
        source_beliefs: List[InvestmentBelief],
        ...
        for agent in target_agents:
            # 根据传播规则筛选信念
            filtered_beliefs = self._filter_beliefs_for_agent(
                source_beliefs, agent, propagation_rules
            )
