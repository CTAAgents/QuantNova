...
def generate_mock_kline(symbol: str, days: int = 120, seed: int = 42, dates: pd.DatetimeIndex = None) -> pd.DataFrame:
    """生成模拟 K 线数据"""
    ...
    def test_report_generation(self):
        ...
        results = [
            FactorEvaluationResult(
                ...
                ic_positive_pct=0.60,
                t_stat=2.5,
                long_short_sharpe=1.3,
                ic_days=60,
                cross_section_size_avg=20,
            ),
            FactorEvaluationResult(
