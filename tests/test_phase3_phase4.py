...
class TestFactorParamOptimizer:
    ...
    def test_optimize_momentum(self):
        """测试优化动量因子参数"""
        from trend_scanner.factor_param_optimizer import PREDEFINED_SPACES, parametric_momentum
    ...
    def test_optimize_rsi(self):
        """测试优化 RSI 因子参数"""
        from trend_scanner.factor_param_optimizer import PREDEFINED_SPACES, parametric_rsi
...
"""
        optimized = self.optimizer.generate_optimized_factor_code(template, {"window": 30})
