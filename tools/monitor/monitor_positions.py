...
def main():
    ...
    if args.output == "json":
        ...
        for r in results:
            ...
            print(
                f"  趋势强度: {indicators.get('trend_strength', 0):.3f} ({indicators.get('strength_change', 0):+.3f})"
            )
    ...
    if args.save and results:
        output_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "latest_monitor.json"
        )
