...
def list_positions():
    ...
    for pos in positions:
        ...
        print(
            f"{symbol:<20} {direction:<8} {entry_price:<10.1f} {current_price:<10.1f} {pnl_str:<10} {holding_days:<8}"
        )
...
def update_position(symbol: str, price: float | None = None, notes: str | None = None):
    """更新持仓价格或备注"""
    data = load_positions()
    positions = data.get("positions", [])
