...
def run_debate(
    reasoning_results: list[dict[str, Any]] = None, symbols: list[str] = None, input_file: str = None
) -> list[dict[str, Any]]:
    """
    执行辩论
...
def main():
    ...
    if args.save and results:
        output_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "latest_debate.json"
        )
